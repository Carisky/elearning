...
const save = async () => {
  ...
  try {
    ...
    notification.value = {
      type: 'error',
      message: e?.data?.message ?? e?.message ?? 'Nie udało się utworzyć',
    }
  } finally {
    saving.value = false
  }
    ...
    <section class="pa-8">
      <v-container fluid>
        <v-row class="mb-4" align="center" justify="space-between">
          <v-col cols="12" md="6">
            <div class="text-h5 font-weight-bold">Nowa forma usługi</div>
            <div class="text-body-2 text-medium-emphasis">
              Utwórz pozycję w słowniku.
            </div>
          </v-col>
              ...
              <v-card-text>
                <v-form @submit.prevent="save">
                  ...
                  <div class="d-flex gap-3">
                    ...
                    <v-btn variant="tonal" :disabled="saving" to="/admin/service-forms">
                      Anuluj
                    </v-btn>
                  </div>
                </v-form>
