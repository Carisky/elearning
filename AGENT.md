# Elearning — правила разработки

Примечание: для Codex/агентов каноническим считается `AGENTS.md`. Этот файл — копия тех же правил, чтобы их было удобно открывать по имени `AGENT.md`.
